...
from lumio.services.assist.router import router
...
def create_assist_app(lifespan: Callable | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        description="银行信用卡智能客服 - 坐席辅助服务。提供 AI 辅助建议、坐席辅助引擎推送、会话管理、反馈收集。",
        version="0.2.0",
        lifespan=lifespan,
        contact={"name": "SmartCS", "url": "https://github.com/slowleelab/QingQue"},
        license_info={"name": "Apache 2.0", "url": "https://www.apache.org/licenses/LICENSE-2.0"},
        openapi_tags=[
            {"name": "assist", "description": "坐席辅助 — 消息分析、坐席辅助引擎推送、会话保持/恢复、事后复盘"},
        ],
        docs_url="/docs",
        redoc_url="/redoc",
    )
    ...
    # OpenTelemetry 全链路追踪
    instrument_app(app, "lumio-assist")
