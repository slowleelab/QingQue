...
消费 kb.ingest.request 主题，执行异步 ETL 管线。
独立进程运行：python -m kb.worker.consumer 或 kb-worker
...
from kb.database import close_engine, get_session_factory
from kb.logging import bind_context, clear_context, configure_logging, get_logger
from kb.orm.kb import KbSourceType
...
from kb.pipeline.orchestrator import ingest_document
from kb.storage.elasticsearch import close_es, get_es, init_es
from kb.storage.kafka import (
    close_producer,
    create_consumer,
    init_producer,
...
from kb.storage.minio import get_minio, init_minio
from kb.storage.redis import (
    acquire_lock,
    clear_retry,
    get_retry_count,
    increment_retry,
