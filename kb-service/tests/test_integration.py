...
""")
    ...
    # 3. Chunk
    from kb.pipeline.chunker import chunk_by_structure
...
def test_embedding_serialization_roundtrip():
    """测试嵌入向量序列化/反序列化"""
    from kb.pipeline.writer import deserialize_embedding, serialize_embedding
...
def test_date_to_epoch_string_and_date():
    ...
    from kb.pipeline.writer import _date_to_epoch
