...
public class NacosRegistrationService implements ApplicationListener<ApplicationReadyEvent> {
    ...
    @Value("${smartcs.nacos.server-addr:127.0.0.1:8848}")
    private String serverAddr;

    @Value("${smartcs.nacos.namespace:public}")
    private String namespace;

    @Value("${smartcs.nacos.service-name:smartcs-mcp-server}")
    private String serviceName;

    @Value("${smartcs.nacos.group:DEFAULT_GROUP}")
    private String group;

    @Value("${smartcs.nacos.instance-ip:}")
