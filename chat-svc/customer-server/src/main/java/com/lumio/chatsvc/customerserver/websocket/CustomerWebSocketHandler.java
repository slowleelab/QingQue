...
import com.lumio.chatsvc.customerserver.zookeeper.CustomerBindingRegistry;
...
public class CustomerWebSocketHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        Session newSession = sessionManager.createSession(new com.lumio.chatsvc.customerserver.dto.CustomerInfo(customerId, null));
